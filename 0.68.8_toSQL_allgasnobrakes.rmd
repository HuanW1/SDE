...
# data.table::fwrite(elr_linelist, paste0("L:/daily_reporting_figures_rdp/elr_linelists/alt_elr_linelist", Sys.Date(), ".csv"), buffMB = 16, nThread = 4, verbose = FALSE, showProgress = FALSE)
```
