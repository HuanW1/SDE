...
# Put this function in here for now
...
```{r plot_thurs_rate_by_age, eval=thursday, dpi=300, fig.height=5, fig.width= 7}
weeks <-  case %>%
...
if (SQL_write) {
  df_to_table(gary_state_file, "ODP_state_result", overwrite = FALSE, append = TRUE)
}
...
if (SQL_write) {
  df_to_table(gary_town_file, "ODP_town_Result", overwrite = FALSE, append = TRUE)
}
...
if (SQL_write) {
  df_to_table(ConProbByDate, "ODP_ConProbByDate", overwrite = FALSE, append = TRUE)
}
...
if (SQL_write) {
  df_to_table(countycountDate, "ODP_CountySummarybyDate", overwrite = FALSE, append = TRUE)
  df_to_table(death_by_deathdate, "ODP_DodSummary", overwrite = FALSE, append = TRUE)
  df_to_table(GenderSummary, "ODP_GenderSummary")
  df_to_table(StateSummary, "ODP_StateSummary")
  df_to_table(AgeGroupSummary, "ODP_AgeGroupSummary")
  df_to_table(CountySummary, "ODP_CountySummary")
  df_to_table(REStateSummary, "ODP_REStateSummary")
  df_to_table(agg_test_gary, "ODP_TestCounty")
}
