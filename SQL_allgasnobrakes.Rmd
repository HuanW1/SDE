...
newcase_tbl_town <- 
  ...
  mutate(Rate = if_else(Cases < 5, NA_real_, Rate),
         Cases = if_else(Cases < 5, NA_real_, Cases),
         across(Population:Rate, as.character),
         Rate = replace_na(Rate, "--"),
         Cases = replace_na(Cases, "--")
  )
...
newcase_tbl_town <- 
  set_header_labels(newcase_tbl_town,
                    town1 = "Town",
                    town2 = "Town",
                    town3 = "Town",
                    n1 = "Cases",
...
newcase_tbl_town <- fontsize(newcase_tbl_town, size = 7, part = "all" )
