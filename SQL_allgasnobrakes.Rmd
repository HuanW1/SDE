...
df_to_table <- 
  function(df_name = NULL, 
           table_name = NULL,
           overwrite = FALSE, 
           append = TRUE) {
    
    ### error checking
    if(is.null(df_name)) stop("You must specify a dataframe")
#    if(!exists(as.character(substitute(df_name)), envir=parent.frame()))  stop("Can not find that dataframe")
...
df_to_table(ovlsum, "test_overall_summary")
