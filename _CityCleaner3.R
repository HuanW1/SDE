...
empty_inds <- c(which(is.na(data$Patient_city)),
                which(data$Patient_city==""),
                which(data$Patient_city=="Unknown"),
                which(data$Patient_city=="Not_available"))
empty_inds <- c(which(is.na(data$Patient_city)),
                which(data$Patient_city==""),
                grep("Unknown",data$Patient_city,ignore.case=TRUE),
                grep("avail",data$Patient_city,ignore.case=TRUE))
