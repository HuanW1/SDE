...
paste0("L:/daily_reporting_figures_rdp/gary_csv/", Sys.Date(), "/TestCounty.csv")
write_csv(countycountDate, paste0("L:/daily_reporting_figures_rdp/gary_csv/", Sys.Date(), "/CountySummarybyDate.csv"))
...
write_csv(REStateSummary , paste0("L:/daily_reporting_figures_rdp/gary_csv/", Sys.Date(), "/REStateSummary.csv"), na = "")
...
write_csv(mastercase, path = paste0("L:/daily_reporting_figures_rdp/town_case_eventids/town_case_eventids/", Sys.Date(), "/", "mastereventidlist.csv"))  
for(i in TOI){
  casesi <- cases %>%  
    filter(city == i) %>% 
    select(eventid)
...
write_csv(casesi, path = paste0("L:/daily_reporting_figures_rdp/town_case_eventids/",Sys.Date(),"/",townlhd$`Health Department Name`[townlhd$Town == i] ,"/",i,"last2week.csv"))  
}
```
