...
town_alert <- read_csv(paste0(dir, "tables/", Sys.Date() - 6, "/TownAlertLevelsTable.csv"))
...
case_dat <- read_csv(paste0(dir, "gary_csv/", Sys.Date() - 6, "/", "CTTown_Alert.csv"))
case_dat1 <- read_csv(paste0(dir, "gary_csv/", Sys.Date()-13, "/", "CTTown_Alert.csv"))
case_dat2 <- read_csv(paste0(dir, "gary_csv/", Sys.Date()-20, "/", "CTTown_Alert.csv"))
